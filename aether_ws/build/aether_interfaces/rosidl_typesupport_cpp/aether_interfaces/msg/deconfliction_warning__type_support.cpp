...
static const _DeconflictionWarning_type_support_symbol_names_t _DeconflictionWarning_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aether_interfaces, msg, DeconflictionWarning)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aether_interfaces, msg, DeconflictionWarning)),
  }
};
...
{
  return &::aether_interfaces::msg::rosidl_typesupport_cpp::DeconflictionWarning_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, aether_interfaces, msg, DeconflictionWarning)() {
  return get_message_type_support_handle<aether_interfaces::msg::DeconflictionWarning>();
}
