...
static const _StartCalibration_Request_type_support_symbol_names_t _StartCalibration_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aether_interfaces, srv, StartCalibration_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aether_interfaces, srv, StartCalibration_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aether_interfaces, srv, StartCalibration_Request)() {
  return &::aether_interfaces::srv::rosidl_typesupport_c::StartCalibration_Request_message_type_support_handle;
}
...
static const _StartCalibration_Response_type_support_symbol_names_t _StartCalibration_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aether_interfaces, srv, StartCalibration_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aether_interfaces, srv, StartCalibration_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aether_interfaces, srv, StartCalibration_Response)() {
  return &::aether_interfaces::srv::rosidl_typesupport_c::StartCalibration_Response_message_type_support_handle;
}
...
static const _StartCalibration_type_support_symbol_names_t _StartCalibration_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aether_interfaces, srv, StartCalibration)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aether_interfaces, srv, StartCalibration)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, aether_interfaces, srv, StartCalibration)() {
  return &::aether_interfaces::srv::rosidl_typesupport_c::StartCalibration_service_type_support_handle;
}
