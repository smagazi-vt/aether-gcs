...
#include "aether_interfaces/msg/detail/calibration_status__rosidl_typesupport_fastrtps_c.h"
...
using _CalibrationStatus__ros_msg_type = aether_interfaces__msg__CalibrationStatus;
...
size_t get_serialized_size_aether_interfaces__msg__CalibrationStatus(
  const void * untyped_ros_message,
...
static uint32_t _CalibrationStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aether_interfaces__msg__CalibrationStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aether_interfaces
size_t max_serialized_size_aether_interfaces__msg__CalibrationStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aether_interfaces__msg__CalibrationStatus;
    is_plain =
      (
...
static size_t _CalibrationStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aether_interfaces__msg__CalibrationStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aether_interfaces, msg, CalibrationStatus)() {
